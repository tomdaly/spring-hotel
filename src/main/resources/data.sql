...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'P1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Adams'), '2019-01-01');
