...
public class GuestServiceTest {
  ...
  @Test
  public void testAddGuest_givenValidDetailsOfNewGuest_shouldReturnNewGuestWithCorrectDetails() {
  ...
  @Test
  public void testAddGuest_givenDetailsOfExistingGuest_shouldReturnExistingGuest() {
    Guest mockGuest = createMockGuest();
  ...
  @Test
  public void testFindGuest_givenExistingGuestName_shouldReturnCorrectGuest() {
    Guest mockGuest = createMockGuest();
    given(guestRepository.findByFirstNameAndLastNameIgnoreCase("Foo", "Bar")).willReturn(mockGuest);
  ...
  @Test
  public void testDeleteGuest_givenNonexistentGuestName_shouldReturnGuestNotFoundMessage() {
  ...
  @Test
  public void testDeleteGuest_givenExistingGuestName_shouldReturnGuestDeletedMessage() {
    Guest mockGuest = createMockGuest();
    given(guestRepository.findByFirstNameAndLastNameIgnoreCase("Foo", "Bar")).willReturn(mockGuest);
  ...
  @Test
  public void
      testDeleteGuest_givenExistingGuestWithExistingReservation_shouldReturnCouldNotDeleteMessage() {
    Guest mockGuest = createMockGuest();
    given(guestRepository.findByFirstNameAndLastNameIgnoreCase("Foo", "Bar")).willReturn(mockGuest);
  ...
  @Test
  public void testAddGuest_givenGuestNameWithProfanityInFirstName_shouldReturnEmptyGuest() {
